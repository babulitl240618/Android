...
public class JoinGroupAdapter extends RecyclerView.Adapter<JoinGroupAdapter.ViewHolder>{
    ...
    int lastPosition = -1;
    public JoinGroupAdapter(ArrayList<DataModel> list, Context context) {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder,
        ...
        //viewHolder.tvDate.setText("Fajleh Rabbi");
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        if (lastPosition==0){ LayoutInflater inflater=(LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            View itemLayoutView=inflater.inflate(R.layout.new_chat_list1, parent,false);
