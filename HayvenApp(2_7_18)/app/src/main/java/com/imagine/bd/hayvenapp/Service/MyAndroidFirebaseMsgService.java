...
public class MyAndroidFirebaseMsgService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
           ...
           /* HashMap<String, String> holder = new HashMap();
            ...
            try {
                ob = new JSONObject(roomId);
                 ...
                 type = ob.getString("type"); // getting value CAD with key from
            ...
            PersistData.setStringData(getApplicationContext(),AppConstant.senderid,sender);
            PersistData.setStringData(getApplicationContext(),AppConstant.reciverid,reciver);
            PersistData.setStringData(getApplicationContext(),AppConstant.request_call_type,type);
           ...
           /* String room_id="";
            ...
            // send notification to all user (global) from here.
            handleNotification(room,sender,reciver,callType,type);
    ...
    private void handleNotification(String message,String sender,String reciver,String calltype,String type) {
        if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
            ...
            pushNotification.putExtra("calltype", calltype);
            ...
            //  ((MainActivity) getApplicationContext()).connectToRoom1(message, false, false, false, 0);
           /* Intent notificationIntent = new Intent(getApplicationContext(), MainActivity.class);
            ...
            //  NotificationUtils.getInstance().playNotificationSound(true);
