...
public class IncomingCallActivity extends AppCompatActivity {
    ...
    private ImageView imageView, imgReciveCall, imgCancelCall,imgfriendPic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvFriendname.setText(AppConstant.findNameById(PersistData.getStringData(con,AppConstant.senderid)));
        Picasso.with(con)
                //   .load(PersistData.getStringData(con, AppConstant.person_pic_url))
                .load(API_URL.PHOTO_BASE_URL+AppConstant.findImgById(PersistData.getStringData(con,AppConstant.senderid)))
      ...
      /*  imageView.setOnClickListener(new View.OnClickListener() {
        ...
        imgCancelCall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String userId = PersistData.getStringData(con, AppConstant.userId);
                String friendId = PersistData.getStringData(con, AppConstant.firebaseFriendId);

                Log.e("friend_id", friendId + " aaa");
              //  String friend_id = "fadb049c-6714-4b0b-8419-d2ef2c051345";
                requesCall(userId, friendId, Config.CANCEL_CALL, "cancel request");

            /*  if (friendId != null) {
                    requesCall(userId, friend_id, "cancel", "roomid");
                }  */
