...
public class NewChatAdapter extends ArrayAdapter<DataModel> implements View.OnClickListener{
    ...
    public NewChatAdapter(ArrayList<DataModel> data, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            if (position==0){
                ...
                LayoutInflater inflater = LayoutInflater.from(getContext());
                convertView = inflater.inflate(R.layout.new_chat_list2, parent, false);
                viewHolder.txtName = (TextView) convertView.findViewById(R.id.name);
                viewHolder.txtType = (TextView) convertView.findViewById(R.id.type);
                //viewHolder.txtVersion = (TextView) convertView.findViewById(R.id.version_number);
                viewHolder.imgProfil = (ImageView) convertView.findViewById(R.id.imgProfile);
